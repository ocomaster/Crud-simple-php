...
<!-- Funcion strpos funciona para detectar alguna palabra en el texto  -->
<!-- $_SERVER['REQUEST_URI'] hace captura de la ruta URL actual  -->
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
            ...
            <li><a class="dropdown-item" href="/proyecto/view/username/create.php">Agregar nuevo ususario</a></li>
          </ul>
        </li>
      </ul>
    </div>
